...
## FIK-10 stratospheric balloon flight

As a reference use case, AIRDOS03 was used as part of the [FIK-10 stratospheric balloon mission](https://github.com/ODZ-UJF-AV-CR/FIK-10), providing an example of the detector's use in a lightweight high-altitude platform. The flight data below show the main measured quantities recorded during the balloon campaign.
