...
The avionics that flew the later FIK missions has been productized as the **[TF-B1 stratospheric balloon kit](https://docs.thunderfly.cz/instruments/TF-B1/)**, available from ThunderFly. The kit is a complete carrier: airframe, TF-ATMON avionics with redundant telemetry ([TFSIK01](https://docs.thunderfly.cz/avionics/TFSIK01/) + [TFLORA01](https://docs.thunderfly.cz/avionics/TFLORA01/)), [GNSS tracking, timestamping](https://docs.thunderfly.cz/avionics/TFGPS01/) and recovery beacon, modular UART payload interface, and battery system suitable for stratospheric temperatures. Any UST's detector can be attached as a [TF-ATMON](https://docs.thunderfly.cz/instruments/TF-ATMON/) payload without writing platform-specific firmware — the on-board logger records the payload data together with synchronized environment and trajectory information out of the box.
