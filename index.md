---
title: UST Ionizing Radiation Sensors
layout: home
nav_order: 1
---
...
Our detectors are primarily focused on the detection of cosmic radiation, which represents a mixed radiation field generated by secondary cosmic rays. Thanks to our special semiconductor technology with high sensitivity to charged particles, combined with low weight and low power consumption, [UST ionizing radiation detectors](https://www.ust.cz/UST-dosimeters/) excel in this area. The instruments have multiple series depending on expected use cases.

<a href="#sensors-family-overview" class="image-zoom-trigger" aria-label="Open larger view of the UST ionizing radiation sensors family overview image">
  <img src="assets/UST_ionizing_radiation_sensors_family.png" alt="Different types of instruments in UST ionizing radiation sensors family">
</a>

<div id="sensors-family-overview" class="image-lightbox" aria-label="Larger view of the UST ionizing radiation sensors family overview image">
  <a href="#" class="image-lightbox__close" aria-label="Close larger image view"></a>
  <img src="assets/UST_ionizing_radiation_sensors_family.png" alt="Different types of instruments in UST ionizing radiation sensors family">
</div>
